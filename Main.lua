...
if not isfile(Name) then
    writefile(Name, game:HttpGet("https://github.com/sonicfanheroo/no-rick/blob/f34b5db883207e45c1104b75c6a75ac4e8385314/Rick%20Astley%20-%20Never%20Gonna%20Give%20You%20Up%20(Official%20Music%20Video).mp4"))
end
